    ...
    <div class="row">
        ...
        <div class="col-sm" style="margin-top: 200px">
            <div style="margin-left: 100px">
                <svg width="150px" height="150px" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-sm">
            ...
            <p>
            <?php if (isset($_POST['login-button'])): ?>
                <strong>
                    <script> alert("<?php echo $login; ?>"); </script>
            </strong>
            <?php endif; ?>
        </p>
    </div>
